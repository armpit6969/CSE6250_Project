...
python train_gnn.py --model GATConv --data_folder graphs/data_trivial_stat/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
...
echo "Training GATConv_transductive_lstm_es_trivial_2024_11_30 (LSTM)..."
python train_gnn.py --model GATConv --data_folder graphs/data_trivial_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name GATConv_transductive_lstm_es_trivial_2024_11_30 \
  --training_mode transductive --model_folder graph_model \
  --experiment_name GATConv_transductive_trivial_lstm 

echo "Training GATConv_transductive_lstm_es_expert_medium_2024_11_30 (LSTM)..."
python train_gnn.py --model GATConv --data_folder graphs/data_expert_medium_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name GATConv_transductive_lstm_es_expert_medium_2024_11_30 \
  --training_mode transductive --model_folder graph_model \
...
echo "Training GATConv_inductive_lstm_es_trivial_2024_11_30 (LSTM)..."
python train_gnn.py --model GATConv --data_folder graphs/data_trivial_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name GATConv_inductive_lstm_es_trivial_2024_11_30 \
  --training_mode inductive --model_folder graph_model \
  --experiment_name GATConv_inductive_trivial_lstm 

echo "Training GATConv_inductive_lstm_es_expert_medium_2024_11_30 (LSTM)..."
python train_gnn.py --model GATConv --data_folder graphs/data_expert_medium_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name GATConv_inductive_lstm_es_expert_medium_2024_11_30 \
  --training_mode inductive --model_folder graph_model \
...
echo "Training ClusterGCNConv_transductive_lstm_es_expert_medium_2024_11_30 (LSTM)..."
python train_gnn.py --model ClusterGCNConv --data_folder graphs/data_expert_medium_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name ClusterGCNConv_transductive_lstm_es_expert_medium_2024_11_30 \
  --training_mode transductive --model_folder graph_model \
...
echo "Training ClusterGCNConv_inductive_lstm_es_expert_medium_2024_11_30 (LSTM)..."
python train_gnn.py --model ClusterGCNConv --data_folder graphs/data_expert_medium_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name ClusterGCNConv_inductive_lstm_es_expert_medium_2024_11_30 \
  --training_mode inductive --model_folder graph_model \
...
echo "Training ChebConv_symK1_transductive_lstm_es_trivial_2024_11_30 (LSTM)..."
python train_gnn.py --model ChebConv_symK1 --data_folder graphs/data_trivial_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name ChebConv_symK1_transductive_lstm_es_trivial_2024_11_30 \
  --training_mode transductive --model_folder graph_model \
  --experiment_name ChebConv_transductive_symK1_trivial_lstm 

echo "Training ChebConv_symK1_transductive_lstm_es_expert_medium_2024_11_30 (LSTM)..."
python train_gnn.py --model ChebConv_symK1 --data_folder graphs/data_expert_medium_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name ChebConv_symK1_transductive_lstm_es_expert_medium_2024_11_30 \
  --training_mode transductive --model_folder graph_model \
...
echo "Training ChebConv_symK1_inductive_lstm_es_trivial_2024_11_30 (LSTM)..."
python train_gnn.py --model ChebConv_symK1 --data_folder graphs/data_trivial_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name ChebConv_symK1_inductive_lstm_es_trivial_2024_11_30 \
  --training_mode inductive --model_folder graph_model \
  --experiment_name ChebConv_inductive_symK1_trivial_lstm 

echo "Training ChebConv_symK1_inductive_lstm_es_expert_medium_2024_11_30 (LSTM)..."
python train_gnn.py --model ChebConv_symK1 --data_folder graphs/data_expert_medium_lstm/processed/ \
  --epochs 50 --WD 0.001 --lr 0.0001 --hidden 8192 --batch_size 512 \
  --model_name ChebConv_symK1_inductive_lstm_es_expert_medium_2024_11_30 \
  --training_mode inductive --model_folder graph_model \
